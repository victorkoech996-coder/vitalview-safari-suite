    ...
    <section id="lodges" className="section-padding bg-cream">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide">
          {lodges.map((l, i) => (
            <ScrollReveal key={i} delay={i * 0.08} className="min-w-[280px] sm:min-w-[320px] snap-start shrink-0">
              <div className="rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 group bg-background">
